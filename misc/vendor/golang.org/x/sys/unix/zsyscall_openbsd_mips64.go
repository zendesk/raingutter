<<<<<<< HEAD:vendor/golang.org/x/sys/unix/zsyscall_openbsd_arm64.go
...
>>>>>>> 22a3980 (Migrate to Go Modules and build from 1.16.3-alpine3.13):misc/vendor/golang.org/x/sys/unix/zsyscall_openbsd_mips64.go
